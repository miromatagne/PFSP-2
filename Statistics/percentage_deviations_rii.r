...
x <- barplot(deviations.50,names.arg=probabilities,col="lightblue",main="Percentage deviations for 50 jobs", ylab="Percentage deviation (%)",ylim=c(0,6),cex.lab=2.5,cex.main=4,cex.axis=2,cex.names=2.5)
y <- as.matrix(deviations.50)
